...
describe('NodeSubtasks Component', () => {
  const mockSubtasks: SubTask[] = [
    ...
    { id: '2', title: 'Second Task', description: 'Description for second task', completed: true },
  ...
  it('renders all subtasks correctly', () => {
    render(<NodeSubtasks subtasks={mockSubtasks} onSubtaskChange={onSubtaskChangeMock} />);
  ...
  it('shows success message when all tasks are completed', () => {
    ...
    render(<NodeSubtasks subtasks={allCompletedTasks} onSubtaskChange={onSubtaskChangeMock} />);
